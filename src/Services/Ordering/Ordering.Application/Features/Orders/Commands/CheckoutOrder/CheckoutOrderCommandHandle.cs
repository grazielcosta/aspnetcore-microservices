...
namespace Ordering.Application.Features.Orders.Commands.CheckoutOrder
{
    public class CheckoutOrderCommandHandle : IRequestHandler<CheckoutOrderCommand, int>
    {
        ...
        {
            var email = new Email() { To = "graziel@gmail.com", Body = $"Order was created.", Subject = "Order was created" };
            ...
            {
                _logger.LogError($"Order {order?.Id?? 0} failed due to an error with the mail service: {ex.Message}");
            }
        }
    }
}
